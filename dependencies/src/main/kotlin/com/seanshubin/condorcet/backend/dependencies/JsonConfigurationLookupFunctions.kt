...
class JsonConfigurationLookupFunctions(
    ...
    override val lookupDatabaseUser: () -> String = configuration.createStringLookup("database-user", listOf("database", "user"))
    ...
    override val lookupServerPort: () -> Int  = configuration.createIntLookup(80, listOf("server", "port"))
}
