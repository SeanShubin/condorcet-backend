...
order by id;
insert into event (`when`, authority, type, text)
values ('2022-01-21 06:18:24.789737', 'Bob', 'AddUser', '{"name":"Bob","email":"bob@email.com","salt":"79E90A5258764397DA853AFCED2F88E7","hash":"80C423B16D0C9AF27A95362F0878674736259463102B89CF9B2387E0F10EBB7C","role":"OBSERVER"}');
select id, `when`, authority, type, text
from event
where id > 1
order by id;
insert into event (`when`, authority, type, text)
values ('2022-01-21 06:18:24.923599', 'Carol', 'AddUser', '{"name":"Carol","email":"carol@email.com","salt":"E79BFDA7276912CC49F1DC28BA2E8CBD","hash":"5D3B307F0C357D4687FC3A658473C204DB825F831AB12B7DED00AF05E11EA914","role":"OBSERVER"}');
select id, `when`, authority, type, text
from event
where id > 2
order by id;
insert into event (`when`, authority, type, text)
values ('2022-01-21 06:18:25.034614', 'Dave', 'AddUser', '{"name":"Dave","email":"dave@email.com","salt":"299B27AEEF6F189B4C56090474AC5239","hash":"4BBF4E6580F022C50E1BFD10F9CF0DD3D310D1712BA4BE8F9296BEF3792C7CB5","role":"OBSERVER"}');
select id, `when`, authority, type, text
from event
where id > 3
order by id;
insert into event (`when`, authority, type, text)
values ('2022-01-21 06:18:25.168424', 'Eve', 'AddUser', '{"name":"Eve","email":"eve@email.com","salt":"11DD7B4117C780908F18A402A48C8079","hash":"98E94206D70222DCB5B7360C64E80898AF6BDC3ACEB046B8945A02B7515BB211","role":"OBSERVER"}');
select id, `when`, authority, type, text
from event
where id > 4
order by id;
