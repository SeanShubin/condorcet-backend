...
insert into event (`when`, authority, type, text)
values ('2021-12-30 03:47:50.396089', 'Alice', 'CastBallot', '{"voterName":"Alice","electionName":"Favorite Ice Cream","rankings":[{"name":"Vanilla","rank":1},{"name":"Chocolate","rank":2}]}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 03:47:50.519411', 'Alice', 'RemoveCandidates', '{"electionName":"Favorite Ice Cream","candidateNames":["Strawberry"]}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 03:47:50.52543', 'Alice', 'AddCandidates', '{"electionName":"Favorite Ice Cream","candidateNames":["Butter Pecan","Neapolitan","Mint","Chocolate Chip"]}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 03:47:50.768159', 'Alice', 'RescindBallot', '{"voterName":"Alice","electionName":"Favorite Ice Cream"}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 18:52:08.744169', 'Alice', 'CastBallot', '{"voterName":"Alice","electionName":"Favorite Ice Cream","rankings":[{"name":"Chocolate Chip","rank":1},{"name":"Neapolitan","rank":2},{"name":"Chocolate","rank":3},{"name":"Vanilla","rank":4},{"name":"Butter Pecan","rank":5},{"name":"Mint","rank":6}]}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 18:52:08.756192', 'Alice', 'UpdateElection', '{"name":"Favorite Ice Cream","updates":{"newName":null,"secretBallot":null,"clearNoVotingBefore":null,"noVotingBefore":null,"clearNoVotingAfter":null,"noVotingAfter":null,"restrictWhoCanVote":null,"ownerCanDeleteBallots":null,"auditorCanDeleteBallots":null,"isTemplate":null,"allowVote":false,"allowEdit":false}}');
insert into event (`when`, authority, type, text)
values ('2021-12-30 19:21:10.7203', 'Alice', 'DeleteElection', '{"name":"Delete Me"}');
select count(id)
from event;
select * from event;
insert into event (`when`, authority, type, text)
values ('2021-12-30 19:21:10.807202', 'Bob', 'CastBallot', '{"voterName":"Bob","electionName":"Favorite Ice Cream","rankings":[{"name":"Chocolate","rank":1},{"name":"Chocolate Chip","rank":2},{"name":"Vanilla","rank":3},{"name":"Mint","rank":4},{"name":"Butter Pecan","rank":5},{"name":"Neapolitan","rank":6}]}');
insert into event (`when`, authority, type, text)
values ('2022-01-10 18:26:27.787505', 'Dave', 'CastBallot', '{"voterName":"Dave","electionName":"Favorite Ice Cream","rankings":[{"name":"Mint","rank":1},{"name":"Chocolate Chip","rank":2},{"name":"Neapolitan","rank":3},{"name":"Chocolate","rank":4},{"name":"Vanilla","rank":5},{"name":"Butter Pecan","rank":6}]}');
