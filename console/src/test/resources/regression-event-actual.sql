...
values ('2021-02-15 07:56:19.715621', 'Alice', 'AddUser',
        '{"name":"Alice","email":"alice@email.com","salt":"8d027cff-d538-4078-8de9-b15c0c46d383","hash":"972A59B9F4F03166E3023CFE496F179F1AEACBAC0D8BEA2A5E28676D384A2BC4","role":"OWNER"}');
insert into event (`when`, authority, type, text)
values ('2021-02-15 07:56:19.863825', 'Bob', 'AddUser',
        '{"name":"Bob","email":"bob@email.com","salt":"9cfdf833-a1cb-487a-bf8e-a2efd8b209a4","hash":"7961966BF84F86F943E0B56DB8CF66075CB7B160811FF2995107F7715D4F9D6C","role":"UNASSIGNED"}');
insert into event (`when`, authority, type, text)
...
insert into event (`when`, authority, type, text)
values ('2021-02-24 19:26:02.441961', 'Alice', 'UpdateElection',
...
insert into event (`when`, authority, type, text)
values ('2021-02-24 19:26:02.579771', 'Alice', 'SetCandidates',
        '{"electionName":"Favorite Ice Cream","candidateNames":["Chocolate","Vanilla","Strawberry"]}');
insert into event (`when`, authority, type, text)
