...
object SampleDataApp2 {
    ...
    fun main(args: Array<String>) {
        ...
        service.castBallot(alice, "Alice", "Opening Move", listOf(Ranking("Rock", 1),Ranking("Scissors", 2),Ranking("Paper", 3)))
        service.castBallot(bob, "Bob", "Opening Move", listOf(Ranking("Rock", 1),Ranking("Scissors", 2),Ranking("Paper", 3)))
        service.castBallot(carol, "Carol", "Opening Move", listOf(Ranking("Rock", 1),Ranking("Scissors", 2),Ranking("Paper", 3)))
        service.castBallot(dave, "Dave", "Opening Move", listOf(Ranking("Paper", 1),Ranking("Rock", 2),Ranking("Scissors", 3)))
        service.castBallot(eve, "Eve", "Opening Move", listOf(Ranking("Paper", 1),Ranking("Rock", 2),Ranking("Scissors", 3)))
        service.castBallot(frank, "Frank", "Opening Move", listOf(Ranking("Paper", 1),Ranking("Rock", 2),Ranking("Scissors", 3)))
        service.castBallot(grace, "Grace", "Opening Move", listOf(Ranking("Scissors", 1),Ranking("Paper", 2),Ranking("Rock", 3)))
        service.castBallot(heidi, "Heidi", "Opening Move", listOf(Ranking("Scissors", 1),Ranking("Paper", 2),Ranking("Rock", 3)))
        service.castBallot(ivy, "Ivy", "Opening Move", listOf(Ranking("Scissors", 1),Ranking("Paper", 2),Ranking("Rock", 3)))
        service.castBallot(judy, "Judy", "Opening Move", listOf(Ranking("Scissors", 1),Ranking("Paper", 2),Ranking("Rock", 3)))
