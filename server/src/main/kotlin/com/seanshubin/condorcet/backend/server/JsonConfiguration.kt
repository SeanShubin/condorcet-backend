...
class JsonConfiguration(
    ...
    override val mail: MailConfiguration = object: MailConfiguration {
        override val lookupHost: () -> String = configurationFactory.createStringLookup("email-host", listOf("mail", "host"))
        override val lookupUser: () -> String = configurationFactory.createStringLookup("email-user", listOf("mail", "user"))
        override val lookupPassword: () -> String = secretsConfigurationFactory.createStringLookup("email-password", listOf("mail", "password"))
        override val lookupFromAddress: () -> String = configurationFactory.createStringLookup("email-from-address", listOf("mail", "from"))
    }
